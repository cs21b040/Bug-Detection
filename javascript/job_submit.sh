...
python3 /scratch/cs21b052/SEProject/python2/BugLearn.py --pattern SwappedBinOperands --token_emb /scratch/cs21b052/SEProject/token_to_vector*.json --type_emb /scratch/cs21b052/SEProject/type_to_vector.json --node_emb /scratch/cs21b052/SEProject/node_type_to_vector.json --training_data /scratch/cs21b052/SEProject/binOps_train/*.json
