...
class LearningData(object):
    ...
    def code_to_xy_pairs(self, gen_negatives, bin_op, xs, ys, name_to_vector, type_to_vector, node_type_to_vector, code_pieces):
        ...
        # for all xy-pairs: y value = probabilPy that incorrect
        x_correct = []
        x_correct.append(left_vector)
        x_correct.append(right_vector)
        x_correct.append(operator_vector)
        x_correct.append(left_type_vector[0])
        x_correct.append(right_type_vector[0])
        x_correct.append(parent_vector[0])
        x_correct.append(grand_parent_vector[0])
        """ left_vector + right_vector + operator_vector + left_type_vector + right_type_vector + parent_vector + grand_parent_vector """
        ...
        if gen_negatives:
            ...
            x_incorrect.append(left_type_vector[0])
            x_incorrect.append(right_type_vector[0])
