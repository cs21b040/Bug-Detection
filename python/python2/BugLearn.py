...
# from keras.layers.recurrent import GRU # Nuv rasina lines bro nen macha
...
if __name__ == '__main__':
    ...
    rnn_output = GRU(200, return_sequences=False)(basic_input)
    # rnn_att=SeqSelfAttention(attention_activation='sigmoid')(rnn_output)
    dense_output = Dense(200, activation="relu")(rnn_output)
